...
DOMAIN_NAME = "https://" + MY_DOMAIN_NAME
DOMAIN_NAME_HTTP = "http://" + MY_DOMAIN_NAME
...
MINIO_SERVER = MY_DOMAIN_NAME + ":9000"#"minio:9000"  # Internal to sregistry
MINIO_EXTERNAL_SERVER = (
        MY_DOMAIN_NAME + ":9000" #"127.0.0.1:9000"  # minio server for Singularity to interact with
)
